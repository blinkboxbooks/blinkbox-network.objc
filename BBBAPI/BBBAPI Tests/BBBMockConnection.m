...
@interface BBBMockConnection ()

@end

@implementation BBBMockConnection


- (void) perform:(BBBHTTPMethod)method completion:(void (^)(id data, NSError *))completion{
    [self perform:method forUser:nil completion:completion];
}

- (void) perform:(BBBHTTPMethod)method forUser:(BBBUserDetails *)user completion:(void (^)(id, NSError *))completion{
